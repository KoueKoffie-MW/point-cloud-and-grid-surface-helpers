function [pointCloud, imageMatrix] = generateSplineCylinderPointCloud(spline_definition_points, cylinder_radius, num_cloud_points, use_smooth_spline_flag, patchColor, markerColor, output_filename_base,alpha_mod)
